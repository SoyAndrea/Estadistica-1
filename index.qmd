...
[^1]: [Triola, Mario F. Estadística Decimoprimera edición. PEARSON EDUCACUCIÓN, México, 2013](https://drive.google.com/file/d/1xowvEAFQX6KltZgLeKWigZ_PDnJ566_g/view?usp=drive_link)
...
[^3]: [Triola, Mario F. Estadística Decimoprimera edición. PEARSON EDUCACUCIÓN, México, 2013](https://drive.google.com/file/d/1xowvEAFQX6KltZgLeKWigZ_PDnJ566_g/view?usp=drive_link)
...
-   Regla de decision: se fija el valor maximo de error tipo I que se esta dispuesto a cometer ($\alpha$). Se calcula la probabilidad de rechazar ${H_0}$ cuando es verdadera usando la informacion de la muestra (p-value). Si este valor es menor o igual a $\alpha$ rechazo la hipotesis nula, en caso contrario no la rechazo.
...
g_a1 <- barplot(
        ...
        beside = T,
        main="frecuencia absoluta ocio según género",
        xlab="género",
        ylab="casos",
        border=paleta7,
        col= paleta7,
...
g_a2 <- barplot(p11,
                beside = T,
        main="frecuencia porcentual ocio según género",
        xlab="género",
        ylab="porcentaje",
        border= paleta7,
        col= paleta7,
...
g_a3 <- barplot(
        ...
        beside = T,
        main="frecuencia absoluta ocio según colegio",
        xlab="colegio",
        ylab="casos",
        border=paleta7,
        col= paleta7,
...
g_a4 <- barplot(p22,
                beside = T,
        main="frecuencia porcentual ocio según colegio",
        xlab="colegio",
        ylab="porcentaje",
        border= paleta7,
        col= paleta7,
...
g_a5 <- barplot(
        ...
        beside = T,
        main="frecuencia absoluta situación sentimental según percepción religiosa",
        xlab="percepción religiosa",
        ylab="casos",
        border=paleta4,
        col= paleta4,
        #density=100,
...
g_a7 <- barplot(
        ...
        beside = T,
        main="frecuencia absoluta percepción religiosa  según lugar de estudio",
        xlab="percepción religiosa",
        ylab="casos",
        border=paleta3,
        col= paleta3,
...
g_a8 <- barplot(p44,
                beside = T,
        main="frecuencia porcentual percepción religiosa  según lugar de estudio",
        xlab="percepción religiosa",
        ylab="porcentaje",
        border= paleta3,
        col= paleta3,
...
cuestionario <- expss::apply_labels(cuestionario,
                             ...
                             religion = "Autopercepción religiosa",
...
cuestionario %>%
  get_summary_stats(horas,tv,niños,hijos1,hijos2,libros, ingreso1, ingreso2,ingreso3,edad, type="common")
```
...
boxplot(cuestionario$horas, na.action = NULL,
        xlab = "Horas",
        ylab = "y",
        main="Horas destinadas al tiempo libre", 
        ann = T, 
        horizontal = TRUE,
...
```{r}
boxplot(cuestionario$tv, na.action = NULL,
        xlab = "Horas",
        ylab = "y",
        main="Horas destinadas al tiempo libre", 
        ann = T, 
...
```{r}
boxplot(cuestionario$niños, na.action = NULL,
        xlab = "Horas",
        ylab = "y",
        main="Horas destinadas al tiempo libre", 
        ann = T, 
